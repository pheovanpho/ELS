...
global.client.api = loginApiData;
 ...
 logger.loader(`Thời gian khởi động: ${(Date.now() - global.client.timeStart) / 100}s`);
        logger('CÓ HÀNH VI THAY ĐỔI SOURCE CODE THÌ HÃY TỪ BỎ', 'ELS');
        logger("CHÚC ANH EM CÓ MỘT NGÀY TỐT LÀNH", 'ELS');
...
CFonts.say(`Bot Messenger Created By ELS`, {
		font: 'console',
		align: 'center',
		gradient: ['red', 'magenta']
		})*/
...
console.log(color('[ CLIENT ]→', 'cyan'), color('BOT ELS successfully activated!! ', 'yellow'));
/*console.log(chalk.bold.hex("[ CLIENT ]" + randomColor).bold("Đang kết nối đến BOT ELS..."));
console.log(chalk.bold.hex("[ CLIENT ]" + randomColor).bold("BOT ELS successfully activated!!"));*/
